...
/*
 ○ java.lang.Math 클래스는
	...
	인스턴스를 생성할 필요없이 math.로 접근하여 사용가능함
...
○ java.lang.Math 클래스의 주요 상수 및 메소드
	...
	- public static doble log(double a)
	 : 로그(log) 값을 구하여 반환한다.
	
	- public static double sqrt(double a) - 사용빈도 있음
	 : a의 제곱근을 구하여 반환한다.

	- public static double ceil(double a)
	 : a 보다 크거나 같은 정수 형태를 반환한다(올림의 개념)
...
public class Test140
{
	public static void main(String[] args)
	{
		...
		while (n<4)
		{
			...
			//--==>>0.0 ~ 1.0 사이의 난수 : 0.896224727926514
			n++;
		}
		//0.0 ~ 1.0 사이의 난수 : 0.4796600513315237
		//0.0 ~ 1.0 사이의 난수 : 0.07111725088432053
		//0.0 ~ 1.0 사이의 난수 : 0.18144860907283278
		//0.0 ~ 1.0 사이의 난수 : 0.46035354364587666
	}
}