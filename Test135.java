/*============================================
	■■■ 자바의 주요(중요) 클래스 ■■■
	- StringTokenizer 클래스 - 중요도0
============================================*/
/*
 ○ StringTokenizer 클래스는
 	문자열 파싱(parsing)을 위한 정보로 제공하는 클래스로
	파싱(parsing)하고자 하는 문자열을 인자로 받아 생성하는데
	여기서 파싱(parsing)이란 하나의 문자열을 여러 문자열로
	...
	보관 유지되고 있으며(안쓰며) 문자열을 파싱(parsing)하기 위해서는
	String 클래스의 split() 메소드나 java.util.ragex 패키지를
	사용할 것을 권장하고 있다.

 ○ 생성자
 	- 원형
	  StringTokenizer(String srt)
	  StringTokenizer(String str, String delim)
	  StringTokenizer(String str, string delim, boolean returnDelims)
	  → 주어진 문자열 str를 단어로 분리하는 객체를 생성하며
...
//실행 결과
/*
파싱할 문자열 입력(컴마구분) : aa,bb,cc,dd,ee,ff,gg
파싱된 토큰(문자열) : aa bb cc dd ee ff gg
*/