...
public class Test111
{
	public static void main(String[] args)
	{
		...
		//ob2. print();
		//--==>>에러 발생 → 다운 캐스팅 필요~!!!!
		//-- 슈퍼클래스는 서브 클래스의 메소드를 쓸 수 없다.(반대는 가능)
		...
		//	 다운캐스팅은 불가능한 것이다.
		//	 (SuperTest의 메모리 할당만 하였으므로 SubTest는 메모리할당이 되지 않았음)

		//System.out.println("ob4c : "+ob4.c);
		//--==>> 에러 발생
