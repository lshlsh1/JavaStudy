...
/*
 ○ Hashtable<K, V> 클래스
	...
	- 데이터를 저장하고 검색하기 위해서 키로 접근하며
	  이 구조에서는 키 값을 부여하면 해당 데이터가 반환된다
...
public class Test164
{
	...
	private static final String[] tels  = {"010-9118-5974", "010-4780-3733", "010-9170-3896", "010-1111-1111", "010-2317-7455", "010-2684-4905"};
	...
	public static void main(String[] args)
	{
		...
		// ht라는 해시테이블의 요소 중 값을... key를 이용하여 검색
		String findName1 = "김정규";
		String str = ht.get(findName1);		// get(키) → 값
		if (str != null)	//null이 아닌경우에
		{
		...
		*/
		...
		// ht라는 해시테이블 자료구조에... key가 존재하는지의 여부 확인
		// → containsKey()
		String findName2 = "진윤비";
		
		if (ht.containsKey(findName2))
		{
			System.out.println(findName2 + "의 데이터가 존재합니다.");

		}else
			System.out.println(findName2 + "의 데이터가 존재하지 않습니다.");
		//--==>>진윤비의 데이터가 존재하지 않습니다.

		String findName3 = "김경환";
		if (ht.containsKey(findName3))
			System.out.println(findName3 + "의 데이터가 존재합니다.");

		else
			System.out.println(findName3 + "의 데이터가 존재하지 않습니다.");
		//--==>>김경환의 데이터가 존재합니다.
		...
		if (ht.contains(findTel1))
		{
			...
			System.out.println(findTel1 + "의 데이터가 존재하지 않습니다.");
		//--==>>010-9170-3896데이터가 존재합니다
		...
		if (ht.contains(findTel2))
		{
			...
			System.out.println(findTel2 + "의 데이터가 존재하지 않습니다.");
		//--==>>010-1234-1234의 데이터가 존재하지 않습니다.	
		...
		// null 입력 시도
		//ht.put(null,null);			//-- key, value 모두 null	→ (x) ; NullPointerException
		//ht.put("조현우", null);		//-- value가 null			→ (x) ; NullPointerException
		//ht.put(null, "010-2222-2222");	//-- key가 null				→ (x) ; NullPointerException

		// 중복된 key 값 입력
		ht.put("김정규", "010-9999-9999");
		System.out.println(ht.get("김정규"));
		//--==>>010-9999-9999
		//-- 기존 번호에서 010-9999-9999로 변경되었음을 확인
