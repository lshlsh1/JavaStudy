...
public class Test160
{
	public static void main(String[] args)
	{
		...
		// ArrayList 자료구조 인스턴스 생성
		//-- 이번 생성은... 인스턴스 생성 과정에서 list1을 생성자에게 넘겨줌
		...
		//list3.add("앤트맨과와프스");	//끝에 삽입
		list3.add(n, "앤트맨과와프스");	//n번째에 삽입
		...
		//--==>> [어벤져스, 곡성, 바르다가사랑한얼굴들, 캡틴 마블]
		System.out.println(list3);
		//--==>> [어벤져스, 앤트맨과와프스, 곡성, 바르다가사랑한얼굴들, 캡틴 마블]
		System.out.println();
		...
		//--==>>캡틴 마블 바르다가사랑한얼굴들 곡성 앤트맨과와프스 어벤져스
