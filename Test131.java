...
○ String 객체의 생성 및 특징
	...
	String 객체를 생성하는 방법은
	① 문자열 상수를 지정하는 방법과
	② String 클래스의 생성자를 이용하는 방법 < new!
	이렇게 두 가지 방법이 있다.

	String str1 = "java";			  → 같은 데이터가있으면 같은 주소를 참조
										 문자열 데이터가 바뀌면 새데이터로 이사함
	String str2 = new String("java"); → 무조건 새로운 메모리(new)
