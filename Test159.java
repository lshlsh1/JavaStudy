...
○ Enumeration 과 Iterator 인터페이스
	...
	인터페이스라고 할 수 있다.
	 Enumeration 과 Iterator 기본적으로는 같은 기능 수행

	- java.util.Enumeraton<E> 인터페이스
	...
	- java. util.Iterator<E> 인터페이스
	  : Enumeration 과의 차이점은 단지 『remove()』메소드가 추가된 것 뿐이다.
		...
		정확히 일치하는 기능을 수행한다
		Enumeration 대신 Iteration 를 JDK1.2부터 추가하여 사용하는 이유는
...
public class Test159
{
	public static void main(String[] args)
	{
		...
		while (it.hasNext())	//다음값이 있는지 없는지 확인
		{
			System.out.println(it.next());	//가지고 온다
		}
		//--==>>Java
		//		Oracle
		//		Jsp
