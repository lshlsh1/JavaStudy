...
/*
 ○ 중첩 클래스 개요
	...
	중첩 클래스란 클래스 안에 다른 클래스가 설계되어있는 형태로
 ...
 ○ 중첩 클래스의 종류(4가지)
	...
	2. 내부 클래스(inner class)
		...
		- 내부 멤버 플래스는 외부에ㅓㅅ 단독으로 객체를 생성하여 사용할 수 없다.
		  즉, 내부 멤버 플래스는 외부 클래스 인스턴스 생성이 선행되어야 한다는 것이다.
	...
	4. 익명 클래스(무명 클래스, annoymous class)
	   이름 없는 클래스
...
class Test
{
	...
	public static class StaticNested	//static
	{
		...
		void write()
		{
			...
			//static이 붙지 않은 b때문에 에러 발생
			//staitc keyword - 1.탄생시점 2.공유
...
public class Test117
{
	public static void main(String[] args)
	{
		...
		Test.StaticNested ob3 = new Test.StaticNested(); //static이 붙어있는 중첩클래스의 경우 가능
		ob3.write();
		//--==>>write()...
		//		a : 10
		//		c : 30
