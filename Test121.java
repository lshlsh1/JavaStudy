...
/*
 ○ 개요
	...
	자바 표준 패키지에서는 그래픽, 네트워크, 데이터 베이스 등의
 ...
 ○ import문은
	...
	import되어있기 때문에 이 패키지의 클래스들은 import 하지 않고
	바로 사용하는 것이 가능하다.

	import 문은 반드시 클래스 설계 구문 전에 선언되어있어야 하며
	형식은 다음과 같은 두 가지가 있다.
	...
	※ JDK 1.5 부터는 import 다음에 『static』키워드를 붙임으로써
	   ...
	   만약 패키지를 정적으로 import 한 경우면 모든 접근 가능한
...
public class Test121	//extends Object
{
	...
	*/
	...
	public static void main(String[] args)
	{
		...
		// 임의로생성된객체.xxx();	//-- 대상 클래스가 갖고 있는 메소드 xxx
