...
public class Test151
{
	public static void main(String[] args)
	{
		...
		// element() : 큐 자료구조에서 요소를 제거하지 않고 head요소 반환
		...
		// ① 
		// peek() : 큐의 head요소 반환. 제거 안함
		//			큐가 empty인 경우 null반환
		/*
		while (myQue.peek() != null)
		{
			// poll() : 큐의 head요소를 반환. 제거함
			//		    큐가 empty일 경우 null반환
		...
		//테스트
		/*
		while (myQue.poll() != null) //도는 순간 한 놈을 잡아서 없앰.
		{
			val = (String)myQue.poll();
			System.out.println("요소 : "+val);
		}*/
